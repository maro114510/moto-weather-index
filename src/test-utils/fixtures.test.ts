...
describe("Test Fixtures", () => {
  describe("WeatherFixture", () => {
    ...
    test("should create weather with specific properties", () => {
      ...
      expect(WeatherFixture.withPrecipitationProbability(50).precipitationProbability).toBe(50);
  ...
  describe("TouringIndexBatchItemFixture", () => {
    ...
    test("should create multiple batch items", () => {
      const items = TouringIndexBatchItemFixture.createMultiple(13, "2025-06-01", 3);
  ...
  describe("ApiResponseFixture", () => {
    test("should create touring index history", () => {
      const history = ApiResponseFixture.touringIndexHistory(13, ["2025-06-01", "2025-06-02"]);
    ...
    test("should create validation error", () => {
      const error = ApiResponseFixture.validationError("lat", "Invalid latitude");
  ...
  describe("PerformanceFixture", () => {
    ...
    test("should measure average time", async () => {
      const result = await PerformanceFixture.measureAverageTime(
        async () => {
